...
public class NodeBasedEditor : EditorWindow {
    ...
    private void ProcessContextMenu(Vector2 mousePosition) {
        ...
        genericMenu.AddItem(new GUIContent("1x1 Node"), false, () => OnClickAddNode1(mousePosition));
        genericMenu.AddItem(new GUIContent("2x1 Node"), false, () => OnClickAddNode2(mousePosition));
        genericMenu.AddItem(new GUIContent("3x1 Node"), false, () => OnClickAddNode3(mousePosition));
    ...
    private void OnClickAddNode1(Vector2 mousePosition) {
        if (nodes == null) {
            nodes = new List<Node>();
        }
    ...
    private void OnClickAddNode2(Vector2 mousePosition) {
        if(nodes == null) {
            nodes = new List<Node>();
        }
    ...
    private void OnClickAddNode3(Vector2 mousePosition) {
        if(nodes == null) {
            nodes = new List<Node>();
        }

        nodes.Add(new Node(mousePosition, 200, 300, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle, OnClickInPoint, OnClickOutPoint, OnClickRemoveNode));
    }
    ...
    private void Save() {
        XMLOp.Serialize(nodes, "Assets/XML Saves/nodes.xml");
        XMLOp.Serialize(connections, "Assets/XML Saves/connections.xml");
    }

    private void Load() {
        var nodesDeserialized = XMLOp.Deserialize<List<Node>>("Assets/XML Saves/nodes.xml");
        var connectionsDeserialized = XMLOp.Deserialize<List<Connection>>("Assets/XML Saves/connections.xml");
